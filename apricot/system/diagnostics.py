...
class DiagnosticsMixin:
    ...
    def diagnostic_audio_section(self) -> str:
        ...
        lines = [
            ...
            self.diagnostic_line("Equalizer preset", self.effective_equalizer_preset()),
            ...
            self.diagnostic_line("Equalizer device presets", len(getattr(self.settings, "equalizer_device_presets", {}) or {})),
    ...
    def diagnostic_queue_section(self) -> str:
        lines = [
            ...
            self.diagnostic_line("Last session sequence count", len((getattr(self, "last_player_session", {}) or {}).get("sequence", []) or []) if isinstance(getattr(self, "last_player_session", {}), dict) else 0),
