...
LAST_PLAYER_SESSION_FILE = APP_DIR / "last_player_session.json"
...
STREAM_FORMAT_PREFERENCE_AUTO = "auto"
STREAM_FORMAT_PREFERENCE_VIDEO = "video"
STREAM_FORMAT_PREFERENCE_AUDIO = "audio"
STREAM_FORMAT_PREFERENCE_OPTIONS = [STREAM_FORMAT_PREFERENCE_AUTO, STREAM_FORMAT_PREFERENCE_VIDEO, STREAM_FORMAT_PREFERENCE_AUDIO]
...
MPV_SEEK_RELATIVE_MODE = "relative+keyframes"
MPV_SEEK_ABSOLUTE_MODE = "absolute+exact"
...
SPEED_PITCH_HOLD_DELAY_DEFAULT_MS = 180
SPEED_PITCH_HOLD_DELAY_MIN_MS = 50
SPEED_PITCH_HOLD_DELAY_MAX_MS = 1000
SPEED_PITCH_HOLD_INTERVAL_DEFAULT_MS = 110
SPEED_PITCH_HOLD_INTERVAL_MIN_MS = 20
SPEED_PITCH_HOLD_INTERVAL_MAX_MS = 500
...
SHORTCUT_DEFINITIONS = [
    ...
    ("open_action_finder", "shortcut_open_action_finder"),
    ...
    ("result_column_previous", "shortcut_result_column_previous"),
    ("result_column_next", "shortcut_result_column_next"),
    ...
    ("toggle_podcast_played", "shortcut_toggle_podcast_played"),
    ("clear_podcast_progress", "shortcut_clear_podcast_progress"),
    ("save_podcast_speed_preset", "shortcut_save_podcast_speed_preset"),
    ...
    ("player_bpm", "shortcut_player_bpm"),
    ...
    ("player_format_status", "shortcut_player_format_status"),
    ...
    ("player_fullscreen", "shortcut_player_fullscreen"),
    ...
    ("player_next_related", "shortcut_player_next_related"),
