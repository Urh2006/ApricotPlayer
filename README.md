...
- `scripts/publish_release.ps1 -Tag v1.0.0-beta.46 -NotesFile release-notes/v1.0.0-beta.46.md` publishes the installer and portable ZIP to GitHub Releases
