...
- Normal player mode keeps the current result list visible and tabbable, while fullscreen mode hides results until Back to results is pressed
...
- `scripts/publish_release.ps1 -Tag v0.8.28 -NotesFile release-notes/v0.8.28.md` publishes the installer and portable ZIP to GitHub Releases
