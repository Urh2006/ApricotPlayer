...
- The complete automated suite, source compilation, critical Ruff checks, and whitespace validation pass for the stable source.
- The Windows installer and portable ZIP are built from the stable 1.0 release commit and verified before publication.
